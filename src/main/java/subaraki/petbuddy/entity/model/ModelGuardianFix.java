...
public class ModelGuardianFix extends ModelBase
{
	 ...
	 */
	 ...
	 public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
	 {
		 ...
		 float f1 = 0.2f + Math.min(0.2f,(float)Math.cos(ageInTicks/5f)/4f);
		 ...
		 entity = ((EntityPetBuddy)entityIn).getOwner();
		 ...
		 float f2 = (float)Math.sin(ageInTicks);
